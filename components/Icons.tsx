...
export const NetlifyIcon = ({ className = "w-5 h-5" }: IconProps) => (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path d="M6.433 10.38c.184.22.443.25.642.062l2.678-2.525c.183-.172.168-.429-.033-.585L6.657 5.01c-.167-.13-.41-.097-.56.076L3.92 8.12a.377.377 0 0 0 .056.54l2.457 1.72zM12.44 19.346c.203.22.483.243.692.046l6.634-6.257c.202-.19.185-.473-.037-.645l-3.37-2.617a.417.417 0 0 0-.575.056l-3.385 4.094a.393.393 0 0 0 .041.565l.001-.001zM20.297 9.877L15.352 6.037a.417.417 0 0 0-.617.07l-1.397 1.69a.394.394 0 0 0 .043.565l7.394 5.742a.378.378 0 0 0 .57-.08l1.378-1.927a.416.416 0 0 0-.05-.54l-2.376-1.68z" fill="#00C7B7"/>
    </svg>
);

export const CloudflareIcon = ({ className = "w-5 h-5" }: IconProps) => (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path d="M19.12 9.61h.01c-.02-.17-.03-.34-.03-.51 0-3.04-2.46-5.5-5.5-5.5-2.73 0-4.99 1.98-5.42 4.59-.22-.04-.45-.07-.68-.07-2.21 0-4 1.79-4 4 0 .2.02.4.05.59C1.55 13.1 0 14.86 0 17c0 2.21 1.79 4 4 4h15c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96-.08-.82-.24-1.61-.48-2.36-.26-.82-.62-1.57-1.07-2.25-.49-.73-1.07-1.38-1.74-1.94-.65-.54-1.38-1-2.19-1.35-.8-.34-1.66-.54-2.56-.54-3.59 0-6.5 2.91-6.5 6.5 0 .17.01.34.03.51-.02-.17-.03-.34-.03-.51 0-3.04 2.46-5.5 5.5-5.5 2.73 0 4.99 1.98 5.42 4.59.22-.04.45-.07.68-.07 2.21 0 4 1.79 4 4 0 .2-.02.4-.05.59C13.55 13.1 15.1 14.86 15.1 17c0 2.21-1.79 4-4 4h-3.1c-2.76 0-5-2.24-5-5 0-2.64 2.05-4.78 4.65-4.96.08-.82.24-1.61.48-2.36.26-.82.62-1.57 1.07-2.25.49-.73 1.07-1.38 1.74-1.94.65-.54 1.38-1 2.19-1.35.8-.34 1.66-.54 2.56-.54 3.59 0 6.5 2.91 6.5 6.5 0 .17-.01.34-.03.51z" fill="#F38020"/>
        <path d="M10.08 17.65l-1.93-2.12c-.29-.32-.29-.84 0-1.16l1.93-2.12c.29-.32.77-.32 1.06 0 .29.32.29.84 0 1.16l-1.32 1.45 1.32 1.45c.29.32.29.84 0 1.16-.29.32-.77.32-1.06 0zM13.92 17.65l1.93-2.12c.29-.32.29-.84 0-1.16l-1.93-2.12c-.29-.32-.77-.32-1.06 0-.29.32-.29.84 0 1.16l1.32 1.45-1.32 1.45c-.29.32-.29.84 0 1.16.29.32.77.32 1.06 0z" fill="#F38020"/>
    </svg>
);
