        ...
        <div className="w-full max-w-6xl animate-slideInUp">
            ...
            <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
                ...
                <button 
                    ...
                    className="flex items-center gap-2 px-6 py-3 rounded-full bg-black dark:bg-white text-white dark:text-black font-medium hover:opacity-90 transition-opacity shadow-lg shadow-black/10 dark:shadow-white/10"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div 
                    onClick={onNewProject}
                    className="group relative h-48 rounded-2xl bg-white dark:bg-[#121214] border border-dashed border-gray-300 dark:border-[#27272a] hover:border-gray-400 dark:hover:border-gray-500 transition-all cursor-pointer flex flex-col items-center justify-center gap-4 hover:bg-gray-50 dark:hover:bg-[#18181b]"
                >
                    <div className="w-12 h-12 rounded-full bg-gray-100 dark:bg-[#27272a] group-hover:bg-gray-200 dark:group-hover:bg-[#3f3f46] flex items-center justify-center transition-colors">
                        <PlusIcon className="w-6 h-6 text-gray-500 dark:text-gray-400 group-hover:text-black dark:group-hover:text-white" />
                    </div>
                    <span className="text-gray-500 dark:text-gray-400 font-medium group-hover:text-black dark:group-hover:text-white">Criar novo projeto</span>
                </div>
                    ...
                    >
                        ...
                        <div className="absolute top-5 left-5 right-5 flex justify-between items-start">
                             ...
                             <div className={`w-10 h-10 rounded-lg flex items-center justify-center shadow-sm ${
                                 index % 3 === 0 ? 'bg-blue-50 dark:bg-blue-900/30 text-blue-500 dark:text-blue-400' : 
                                 index % 3 === 1 ? 'bg-purple-50 dark:bg-purple-900/30 text-purple-500 dark:text-purple-400' : 
                             ...
                             <button 
                                ...
                                className="p-2 rounded-lg text-gray-400 hover:bg-red-50 dark:hover:bg-red-500/10 hover:text-red-500 dark:hover:text-red-400 transition-colors opacity-0 group-hover:opacity-100"
                        ...
                        <div className="absolute bottom-5 left-5 right-5">
                            <h2 className="text-xl font-medium text-gray-900 dark:text-white truncate group-hover:text-blue-600 dark:group-hover:text-purple-200 transition-colors">
                                {project.name}
                            </h2>
                            <div className="flex items-center gap-4 mt-2 text-xs text-gray-500 font-medium">
                                <span className="flex items-center gap-1.5 bg-gray-100 dark:bg-[#27272a] px-2 py-1 rounded-md border border-gray-200 dark:border-[#3f3f46]">
